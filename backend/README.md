...
## Project Structure
    ...
    ├── testapiautoconnecto_74011  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_74011`
...
2. Clone this repo and `cd testapiautoconnecto_74011`
